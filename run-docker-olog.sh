...
docker run -d --name=${DOCKER_RUN_NAME} -e ADMIN_PASSWORD=controle -e CERTIFICATE_PASSWORD=SUPERCALIFRAGILISTIC -p 4848:4848 ${DOCKER_MANTAINER_NAME}/${DOCKER_NAME}:${DOCKER_TAG}
